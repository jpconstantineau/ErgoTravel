...
leg3xa =55.7747+deltax*(positionfactor+.2); 
leg3ya =150.2566-deltay*(positionfactor+.2);
leg3anglea = angle;

leg3xb =55.7747+deltax*(positionfactor+.4); 
leg3yb =150.2566-deltay*(positionfactor+.4);
leg3angleba = angle;
  ...
  difference()
  {
    ...
    union() // punch though the standoffs
    {
      ...
      translate([-7.9526,85.8609,0])circle(d=3, $fn=100);
          ...
          translate([legbackx,legbacky+10,6])
            rotate([90,0,legbackangle])
            {punch(6.6129);} 
          translate([legbackx,legbacky+20,6])
            rotate([90,0,legbackangle])
            {punch(6.6129);} 
          translate([legbackx,legbacky-10,6])
            rotate([90,0,legbackangle])
    ...
    union() // punch though the standoffs
    {
      ...
      translate([93.5762,123.4925,0])circle(d=3, $fn=100);
       ...
       translate([leg1x,leg1y,6])
            ...
            {punch(6.6129);} 
          translate([leg1x+10,leg1y,6])
            rotate([90,0,leg1angle])
            {punch(6.6129);}
                     translate([leg1x+20,leg1y,6])
            rotate([90,0,leg1angle])
            {punch(6.6129);} 
            ...
            {punch(6.6129);} 
           translate([leg2x+10,leg2y,6])
            rotate([90,0,leg2angle])
            {punch(6.6129);} 
            
                       translate([leg2x+20,leg2y,6])
            rotate([90,0,leg2angle])
            {punch(6.6129);} 
            ...
            translate([leg3xa,leg3ya,6])
            rotate([90,0,leg3anglea])
            {punch(6.6129);} 
            
            translate([leg3xb,leg3yb,6])
            rotate([90,0,leg3angle])
            {punch(6.6129);} 
